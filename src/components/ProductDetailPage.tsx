...
//                 <Button
//                   onClick={() => {
//                     console.log('AR button clicked, switching to ar-tryOn tab');
//                     setActiveTab('ar-tryOn');
//                     toast.success('Switching to AR Try-On mode!');
//                   }}
...
//             <TabsList className={`grid w-full ${arSupport.supported ? 'grid-cols-4' : 'grid-cols-3'}`}>
...
//                   </div>
//                   <p className="text-gray-700 text-sm">Great quality and fast delivery. Highly recommended!</p>
//                   <div className="mt-2">
...
//                   </div>
//                   <p className="text-gray-700 text-sm">Product as described. Good quality and reasonable price.</p>
//                   <div className="mt-2">
//                     <Badge variant="outline" className="text-green-600 border-green-600 text-xs">
//                       Verified Purchase
//                     </Badge>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <button
                    ...
                    onClick={() => handleChatWithReviewer('Excellent Product!')}
                  >
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <button
                    className="mt-2 flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-full shadow transition border-2 border-blue-600"
                    onClick={() => handleChatWithReviewer('Good value for money')}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25H4.5a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5H4.5a2.25 2.25 0 00-2.25 2.25m19.5 0v.668c0 .456-.122.905-.353 1.294l-7.5 12.5a2.25 2.25 0 01-3.794 0l-7.5-12.5A2.25 2.25 0 014.5 4.5h15z" />
                    </svg>
                ...
                {getUserReviewsByProduct(product.id).map((review) => (
                  <div key={review.id} className="bg-gray-50 rounded-lg p-4">
                    ...
                    <button
                      className="mt-2 flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-full shadow transition border-2 border-blue-600"
                      onClick={() => handleChatWithReviewer(review.username)}
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25H4.5a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5H4.5a2.25 2.25 0 00-2.25 2.25m19.5 0v.668c0 .456-.122.905-.353 1.294l-7.5 12.5a2.25 2.25 0 01-3.794 0l-7.5-12.5A2.25 2.25 0 014.5 4.5h15z" />
                      </svg>
